...
const characterSummary = (character) => {
    ...
    if (character === null || character === void 0 ? void 0 : character.identity) {
        result += `${pronoun === null || pronoun === void 0 ? void 0 : pronoun.he} is of ${((_y = character === null || character === void 0 ? void 0 : character.demographics) === null || _y === void 0 ? void 0 : _y.ethnicity) || 'unknown'} ethnicity. `;
        result += `As for religion, ${pronoun === null || pronoun === void 0 ? void 0 : pronoun.he} follows ${((_z = character === null || character === void 0 ? void 0 : character.demographics) === null || _z === void 0 ? void 0 : _z.religion) || 'no specific religion'}. `;
