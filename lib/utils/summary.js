...
const characterSummary = (character) => {
    ...
    let result = '';
    let characterName = (((_a = character.names) === null || _a === void 0 ? void 0 : _a.firstName) || ((_b = character.names) === null || _b === void 0 ? void 0 : _b.nickName) || (character === null || character === void 0 ? void 0 : character.name));
    let characterFullName = ((((_c = character.names) === null || _c === void 0 ? void 0 : _c.firstName) || '') + ' ' + (((_d = character.names) === null || _d === void 0 ? void 0 : _d.lastName) || '')).trim() || ((_e = character.names) === null || _e === void 0 ? void 0 : _e.nickName) || (character === null || character === void 0 ? void 0 : character.name);
